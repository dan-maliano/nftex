        ...
        <div className="w-full 2xl:max-w-screen-2xl h-auto pt-[104px] m-auto">
          <div className="flex flex-col mx-4 sm:mx-16 lg:mx-[9vw] space-y-6 py-12">
            ...
            <div className="flex flex-col space-y-12">
              ...
              <div className="see-all-title flex flex-cols items-center">
                <h1 className="second-title flex-grow">
                  Related {singleItem.category} Nfts{" "}
                </h1>
                <Link href="/categories">
                  <a className="to-all-link flex-none text-right text-[#A2A6D0] hover:text-white">
                    See All
