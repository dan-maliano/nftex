   ...
   try{
    ...
    return (
        <>
            ...
            <SuccessDialog show={successOpen} closeSuccessModal={closeSuccessModal}>{{modalIconUrl: "/assets/svg/attention-icon",msg:"PLease Connect MetaMask With Goerli NetWork",title:"Attention",buttonTitle:"Cancel"}}</SuccessDialog>
