...
const projectId = '2IGTGWw7UoOl4QWX6F2aIQ7pSpT';
const projectSecret = '19abfbf719cc7e5483ed1bae90bdcedf';
...
const dedicateEndPoint = 'https://nftex.infura-ipfs.io/ipfs'
        ...
        <>
            ...
            <div className='main'>
                <div className='w-full 2xl:max-w-screen-2xl h-auto pt-[104px] m-auto'>
                    <div className='flex flex-col mx-4 sm:mx-12 lg:mx-[9vw] space-y-6 py-12 text-white dark:text-gray-800'>
                        ...
                        <div className='flex flex-col lg:flex-row items-center'>
                            {/* left input element */}
                            <div className='create-form-wrap w-full lg:w-[45%] flex-none flex flex-col space-y-4'>
                                {/* file chooser */}
                                ...
                                <div className='relative text-[#B4BAEF]'>
                                    ...
                                    ></input>
                                    <p className='absolute input-price__currency'>Matic</p>
                                ...
                                {isActive?                                <button className='form__create-button rounded-full bg-gradient-to-b from-[#3461FF] to-[#8454EB] text-white text-base px-6 sm:px-10 py-2 shadow-md m-auto' id="btn-create-nft" onClick={createMarketItem}>Create</button>
                                    :<button className='form__create-button' id="btn-create-nft" >{buttonTitle}</button>}

                            </div>

                            {/* right art element */}
                            <div className='create-img-wrap flex-1 w-full h-full mt-8 lg:mt-0 pl-3 lg:pl-2 lg:pr-0'>
                                <div className='relative w-full h-auto'>
                                    <img src="/assets/png/bg-abstr-nft.png"></img>
                                </div>
                            </div>
                        </div>
                    </div>
