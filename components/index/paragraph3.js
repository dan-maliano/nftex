...
export default function Paragraph3() {
    ...
    return (
        <div className='w-full h-auto'>
            <div className='benefits-wrap grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mx-4 mt-8 sm:mx-16 sm:mt-16 lg:mx-[9vw] lg:mt-[9vw]'>
                {sellNftDetails.map((item, index) => (
                    <div key={"sell-nft" + index.toString()} className='benefits__item grid grid-cols-1 gap-4'>
