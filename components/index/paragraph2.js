  ...
  //Create nft Buy Function
    ...
    return (
        <div className='w-full h-auto'>
            {/* absolute */}
            <div className='relative grid grid-cols-1 gap-8 mx-4 sm:mx-16 lg:mx-[9vw]'>
                {/* galleries */}
                <div className="see-all-title flex flex-cols">
                    <h1 className="second-title flex-grow">Check Top Newest NFTs</h1>
