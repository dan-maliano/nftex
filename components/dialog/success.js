    ...
    return (
        <Transition appear show={props.show} as={Fragment}>
            ...
            <div className="min-h-screen px-4 text-center">
                ...
                >
                <div className="my-modal inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform dark:bg-white shadow-xl">
                    <Dialog.Title
                    as="h3"
                    ...
                    <div className='flex flex-col items-center space-y-4'>
                        ...
                        <button className='my-button text-base px-16 py-2 shadow-md' onClick={props.closeSuccessModal}>{buttonTitle}</button>
                    </div>
                </div>
                </Transition.Child>
            </div>
